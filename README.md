# Available .VANA One-Word Domains (5,622,096)
...
> **Important:** this repository is a **public 9,943-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,622,096 domains** on the canonical page below.

**Public extract:** 9,943 rows · **Live catalog:** 5,622,096 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/vana?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_vana_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/vana?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_vana_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./vana.csv">CSV</a> / <a href="./vana.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_vana_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_vana_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .VANA search](https://unique.domains/domains/tld/vana?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_vana_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .VANA search](https://unique.domains/domains/tld/vana?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_vana_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./vana.csv) or [Download JSON](./vana.json)
...
| ----------------------- | ------------------------------------------------ |
| 9,943-row public sample | 5,622,096 live domains                           |
...
| live.vana       | available | $2,498    | —             | 108            | 55     | 4      | namecheap |
...
> Unique Domains. *Available .VANA One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
