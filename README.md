# Available .VANA One-Word Domains (33,770)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-33%2C770%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **33,770 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 33,770 domains · **Median ask:** $2,388.32 · **High-demand under $2,500:** 64
...
| ----------- | --------- | --------- | ------------- | -------------- | ------ | ------ | --------- |
| here.vana   | available | $2,298    | $2,498        | high           | medium | 4      | namecheap |
| steady.vana | available | $2,498    | —             | high           | low    | 6      | namecheap |
| abo.vana    | available | $2,298    | $2,498        | high           | low    | 3      | namecheap |
| bed.vana    | available | $2,498    | —             | high           | low    | 3      | namecheap |
| boy.vana    | available | $2,498    | —             | high           | low    | 3      | namecheap |
| cxl.vana    | available | $2,298    | $2,498        | high           | low    | 3      | namecheap |
| did.vana    | available | $2,498    | —             | high           | low    | 3      | namecheap |
| egg.vana    | available | $2,498    | —             | high           | low    | 3      | namecheap |
| few.vana    | available | $2,498    | —             | high           | low    | 3      | namecheap |
| hbo.vana    | available | $2,498    | —             | high           | medium | 3      | namecheap |
| iii.vana    | available | $2,298    | $2,498        | medium         | low    | 3      | namecheap |
| ill.vana    | available | $2,498    | —             | high           | low    | 3      | namecheap |
| led.vana    | available | $2,498    | —             | high           | low    | 3      | namecheap |
| les.vana    | available | $2,498    | —             | high           | low    | 3      | namecheap |
| let.vana    | available | $2,498    | —             | high           | low    | 3      | namecheap |
| mid.vana    | available | $2,498    | —             | high           | low    | 3      | namecheap |
...
| rag.vana    | available | $2,498    | —             | high           | low    | 3      | namecheap |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 33,770 live domains                        |
...
> Unique Domains. *Available .VANA One-Word Domains*. Version 2026-09-24. Public GitHub extract for the exact Unique Domains search represented by this repository.
